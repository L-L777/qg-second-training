window.addEventListener('DOMContentLoaded', function () {
    ...
    let personBox = this.document.querySelector('.person-mes')
    for (let i = 0; i < t.length; i++) {
        t[i].addEventListener('click', function () {
            ...
            if (t[i].classList.contains("submit")) {
                submitBox.style.display = "flex"
            }
            if (t[i].classList.contains("check")) {
                lookBox.style.display = "flex"
            }
            if (t[i].classList.contains("ask")) {
                responseBox.style.display = "flex"
            }
            if (t[i].classList.contains("personal")) {
